...
WEATHERS: list[Weather] = [
    Weather(
        ...
        luck_delta=0.10, tension_mult=0.90,
    ),
    Weather(
        "giong", "Giông", "⛈️",
        "Giông tố nổi lên, cá phản kháng dữ dội hơn — dây câu dễ căng hơn "
        "nhưng bù lại vận may câu cũng tăng theo.",
        luck_delta=0.20, tension_mult=1.25,
    ),
    Weather(
        "dem", "Đêm", "🌙",
        "Màn đêm buông xuống, những con cá lớn thường ẩn mình ban ngày bắt "
        "đầu xuất hiện nhiều hơn.",
        luck_delta=0.05, tension_mult=1.0, boss_weight_mult=1.6,
    ),
    Weather(
        "han_han", "Hạn Hán", "🏜️",
        "Hạn hán kéo dài, mực nước cạn khiến cá cắn câu kém hẳn đi.",
        luck_delta=-0.15, tension_mult=1.15,
    ),
    Weather(
        ...
        luck_delta=0.50, tension_mult=0.60, boss_weight_mult=3.0,
    ),
]
